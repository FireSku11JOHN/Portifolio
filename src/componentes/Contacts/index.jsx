...
const DEFAULT_STYLE_BUTTON_CARD = "text-[18px] font-medium text-dark bg-light py-4 px-6 w-fit rounded-[10px] max-tablet:text-[14px] max-tablet:py-2 max-mobile:w-full max-mobile:px-2"
...
export const Contacts = () => {
    return (
        ...
        >
            ...
            <div
                className="flex flex-wrap gap-6 justify-center w-[80%] bg-linear-to-r from-email-dark-blue to-email-blue p-10 z-5 border border-light rounded-lg self-center max-desktop:w-full max-mobile:p-4"
            >
                ...
                <div className="flex flex-col h-fit w-[500px] text-start gap-8 py-3 px-2 rounded-lg bg-linear-to-r from-email-light-blue to-email-sky-blue">
                    ...
                    <div className="flex justify-between gap-2 bg-light text-dark text-[20px] py-1 px-3 rounded-[10px] max-mobile:text-[16px]">
                ...
                <div className="flex flex-col gap-6 text-start w-[500px] ">
                    ...
                    <button
                        className="w-fit text-[16px] text-dark font-medium bg-light rounded-[10px] py-2 px-4"
                    >
                        Enviar
                    </button>
                </div>
